          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              {loading ? (
                ...
                maps.map((map) => (
                  <tr key={map.id} className="hover:bg-slate-50/80 transition">
                    <td className="py-3 px-4 font-semibold text-slate-900">{map.title}</td>
                    <td className="py-3 px-4 font-mono text-slate-500">{map.userEmail}</td>
                    <td className="py-3 px-4 font-mono text-indigo-600 font-bold">{map.nodeCount}</td>
                    <td className="py-3 px-4 font-mono text-slate-500">{map.edgeCount}</td>
                    ...
                    <td className="py-3 px-4 capitalize text-slate-700">{map.category || 'General'}</td>
