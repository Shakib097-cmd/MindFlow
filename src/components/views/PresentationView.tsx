    ...
    switch (theme) {
      ...
      case 'dark':
        return {
          ...
          deckBg: 'bg-slate-900',
          border: 'border-slate-800 shadow-2xl shadow-black/80',
          titleColor: 'text-white',
          subtitleColor: 'text-slate-400',
          bodyColor: 'text-slate-300',
          badgeBg: 'bg-indigo-500/20 text-indigo-300 border-indigo-500/30',
          cardBg: 'bg-slate-800/80 border-slate-700/80 text-slate-200 hover:border-indigo-500',
          cardBulletNum: 'bg-indigo-500 text-white',
          footerBorder: 'border-slate-800 text-slate-500',
          accent: 'text-indigo-400',
          takeawayBg: 'bg-slate-800 border-slate-700 text-slate-200',
          glow: 'bg-indigo-600/10',
        };
      case 'indigo':
        return {
          wrapperBg: 'bg-slate-900',
          deckBg: 'bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-950',
          border: 'border-indigo-800/60 shadow-2xl shadow-indigo-950/80',
          titleColor: 'text-white',
          subtitleColor: 'text-indigo-200',
          bodyColor: 'text-slate-200',
          badgeBg: 'bg-indigo-500/30 text-indigo-200 border-indigo-400/40',
          cardBg: 'bg-indigo-900/40 border-indigo-700/50 text-indigo-100 hover:border-indigo-400',
          cardBulletNum: 'bg-indigo-400 text-indigo-950 font-black',
          footerBorder: 'border-indigo-900/60 text-indigo-300',
          accent: 'text-indigo-300',
          takeawayBg: 'bg-indigo-900/60 border-indigo-600/60 text-white',
